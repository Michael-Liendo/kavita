...
export default function Navbar() {
  return (
    <nav className="py-3.5 sm:py-5 bg-gradient-to-r from-blue-800 via-blue-700 to-blue-700 text-white flex justify-between px-4 sm:px-10 lg:px-28 xl:px-16 2xl:px-60 space-x-4">
